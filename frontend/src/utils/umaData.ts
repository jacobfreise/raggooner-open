...
export const UMA_DICT: Record<string, UmaData> = {
    ...
    'Admire Vega': {
        ...
        aptitudes: {
            surface: { turf: 'A', dirt: 'G' },
            distance: { sprint: 'F', mile: 'C', medium: 'A', long: 'C' },
            style: { frontRunner: 'G', paceChaser: 'G', lateSurger: 'B', endCloser: 'A' }
        }
    },
    'Mejiro Ardan': {
        ...
        aptitudes: {
            ...
            distance: { sprint: 'E', mile: 'B', medium: 'A', long: 'D' },
            style: { frontRunner: 'C', paceChaser: 'A', lateSurger: 'D', endCloser: 'G' }
        }
    },
...
// Extremely fast helper function for fetching by name
