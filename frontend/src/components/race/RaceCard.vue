...
const canEdit = computed(() => {
  ...
  const currentStageName = props.tournament.stages[props.tournament.currentStageIndex]?.name ?? '';
  if (props.stageId !== currentStageName && props.tournament.status === 'active') return false;
